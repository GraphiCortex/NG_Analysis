...
# ---- Inputs / outputs (Oshikawa integration) ----
IN_MERGED = os.path.join("Project", "New_Data_3", "binding_vs_Oshikawa_expression.xlsx")
IN_GOXLS  = os.path.join("Project", "New_Data", "GO_results.xlsx")  # promoter GO workbook
OUT_DIR   = os.path.join("Project", "New_Data_3", "figures", "oshikawa")
...
cats = {
    "Cell cycle":  os.path.join(OUT_DIR, "Scatter_Cell_cycle_oshikawa.png"),
    "DNA repair":  os.path.join(OUT_DIR, "Scatter_DNA_repair_oshikawa.png"),
    "Apoptosis":   os.path.join(OUT_DIR, "Scatter_Apoptosis_oshikawa.png"),
    "Autophagy":   os.path.join(OUT_DIR, "Scatter_Autophagy_oshikawa.png"),
    "Necroptosis": os.path.join(OUT_DIR, "Scatter_Necroptosis_oshikawa.png"),
}
...
for cat, out_png in cats.items():
    ...
    ax.set_title(f"Binding vs. Expression (Oshikawa): {cat}", pad=8, fontsize=11)
